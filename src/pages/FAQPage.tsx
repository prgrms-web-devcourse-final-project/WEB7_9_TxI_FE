...
const faqs: FAQItem[] = [
  ...
  },
  {
    ...
    answer:
      'Dynamic QR 코드를 사용합니다. 티켓은 실시간으로 변경되는 QR 코드로 발급되며, 사용자의 이력이 기록되어 외부 거래와 위조를 원천 차단합니다.',
  },
  {
  ...
  {
    question: '플랫폼 내에서 티켓을 양도할 수 있나요?',
    answer:
      '네, 가능합니다. WaitFair는 안전한 플랫폼 내 양도 시스템을 제공합니다. 모든 거래는 투명하게 기록되며, 최대 1회까지 양도가 가능합니다.',
  },
]
